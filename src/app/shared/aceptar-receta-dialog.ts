...
@Component({
  selector: 'app-acceptrx-dialog',
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule, FormsModule, MatButtonModule, MatDialogModule],


  template: `
    <h2 mat-dialog-title style="text-align: center; font-size: 35px;">¡La receta fue aceptada!</h2>
    <mat-dialog-content style="color:black; font-size: 20px; text-align: center; ">El paciente puede retirar los medicamentos!</mat-dialog-content>
...
export class AcceptRxDialogComponent {}
