...
@Component({
  selector: 'app-nuevopaci-dialog',
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule, FormsModule, MatButtonModule, MatDialogModule],


  template: `
    <h2 mat-dialog-title style="text-align: center; font-size: 35px;">Paciente Nuevo</h2>
    <mat-dialog-content style="color:black; font-size: 20px; text-align: center; ">Paciente ingresado correctamente!</mat-dialog-content>
...
export class AddPaciDialogComponent {}
